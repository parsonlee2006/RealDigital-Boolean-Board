...
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { clk }]; #IO_L6N_T0_VREF_34 Schematic=SW4
# set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { btn[1] }]; #IO_L6P_T0_34 Schematic=SW5
...
#Push Buttons
# set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports { I[0] }]; #IO_L8P_T1_34 Schematic=BTN0
# set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { I[1] }]; #IO_L4N_T0_34 Schematic=BTN1
# set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { I[2] }]; #IO_L24P_T3_34 Schematic=BTN2
