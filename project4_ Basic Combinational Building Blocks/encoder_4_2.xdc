...
set_property -dict { PACKAGE_PIN R19   IOSTANDARD LVCMOS33 } [get_ports { GS }]; #IO_0_34 Schematic=LD2
set_property -dict { PACKAGE_PIN T20   IOSTANDARD LVCMOS33 } [get_ports { Eout }]; #IO_L15P_T2_DQS_34 Schematic=LD3
...
# set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { I[3] }]; #IO_L23P_T3_35 Schematic=BTN3
